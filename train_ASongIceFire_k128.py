...
from NMF_CR_general import DecomAdjMat
import Metrics
import os
...
save_file_dir = r"output/NMF/k_128"
...
weight_data_file = save_file_dir + "/" + "weight_data.txt"
np.savetxt(weight_data_file, weight_mat)
...
k = 128
dis_val = 1.0e-8
U, V, C= DecomAdjMat(col_normalization, weight_mat, alpha_0, alpha_1, beta_0, lambda_0, lambda_1, max_iter_num, k, dis_val)
